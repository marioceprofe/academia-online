# Academia Online — Guía de instalación completa
...
3. Pon un nombre (ej: `academia-online`) y elige una región europea
...
2. Sube tu código a GitHub:
   ...
   git remote add origin https://github.com/TU_USUARIO/academia-online.git
