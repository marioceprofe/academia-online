...
import { useState, Suspense } from 'react' // Añadido Suspense
import Link from 'next/link'
import { useRouter, useSearchParams } from 'next/navigation'
import { BookOpen, Eye, EyeOff, Loader2 } from 'lucide-react'
import { createClient } from '@/lib/supabase/client'

// 1. He movido la lógica del formulario a un componente interno
function LoginForm() {
...
// 2. Este es el componente principal que exportas. 
// Ahora envuelve al formulario en Suspense para que Vercel no de error.
