    ...
    <footer className="bg-ink-950 text-ink-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-display font-semibold text-white text-lg">
                ByteOpos<span className="text-brand-400">Pro</span>
              </span>
            </Link>
        ...
        <div className="mt-16 pt-8 border-t border-ink-800 flex flex-col md:flex-row
          ...
          <p>© {new Date().getFullYear()} ByteOpos. Todos los derechos reservados.</p>
          <p>Tu plaza de informático, un paso más cerca..</p>
        </div>
      </div>
    </footer>
  )
